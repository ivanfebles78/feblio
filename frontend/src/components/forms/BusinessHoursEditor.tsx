...
import type { BusinessHours } from '../../lib/validation'
...
export function BusinessHoursEditor({ value, onChange, error, legend = 'Horario de atención' }: BusinessHoursEditorProps) {
  const id = useId()
  const msgId = `${id}-msg`
