...
describe('SetupProgressCard', () => {
  it('en español por defecto', () => {
    ...
    expect(screen.getByText('2 de 5 áreas completadas · unos 14 min restantes.')).toBeInTheDocument()
  ...
  it('en inglés con setUserLanguage("en"), incluidas las áreas y sin textos españoles', () => {
    ...
    expect(screen.getByText('2 of 5 areas completed · about 14 min remaining.')).toBeInTheDocument()
    ...
    expect(screen.getByRole('img', { name: 'Setup completed: 40%' })).toBeInTheDocument()
