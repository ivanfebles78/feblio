export type SettingsTab = 'empresa' | 'integrations' | 'billing' | 'automation' | 'forms' | 'services' | 'reopen'

export const SETTINGS_TAB_KEYS: SettingsTab[] = ['empresa', 'integrations', 'billing', 'automation', 'forms', 'services', 'reopen']
