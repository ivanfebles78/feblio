...
├── database/
│   ├── migrations/           # 0001 … 0017 (esquema, RLS, RPCs, sincronización de email, endurecimiento, registro v2, solicitudes, idioma público, mensajes de servidor es/en, límite de envíos)
│   ├── seed/                 # Datos de desarrollo (sin credenciales)
│   └── tests/                # 0009_rls_isolation · 0009_backfill · 0010_sync_profile_email · 0011_security_audit · 0011_signup_roles · 0013_registration_v2 · 0014_solicitudes · 0015_i18n_public_language · 0016_i18n_server_messages · 0017_intake_email_rate_limit
